// OpenAI commands the defender bots; ordinary game code executes these bounded orders.
...
const defenders = game => game.units.filter(u => u.kind === 'bot' && u.team === 'defend' && u.alive);
...
export function opponentSnapshot(game) {
  ...
  return {
    ...
    contacts: [...game.intel.defend.entries()]
